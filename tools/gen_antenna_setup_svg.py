...
# ---- C ----------------------------------------------------------------
yC = 630
txt(30, yC, "C  ＋ アルミホイルを「斜め上 5mm」（本体基板を模擬）", 18, "start", "bold")
txt(30, yC + 22, "真横でも真上でもない。本体基板はアンテナのやや前方・やや上にある。最短で 5mm になるよう斜めに構える。", 14, "start", "normal", "#555")
# 横から見た図
bx, by = 90, yC + 60
txt(bx, by - 8, "【横から見た図】", 14, "start", "bold")
line(bx - 20, by + 96, bx + 420, by + 96, "#aaa", 2)          # 机
txt(bx + 424, by + 100, "机", 13, "start", "normal", "#888")
rect(bx + 60, by + 84, 120, 12, "#cfe3f7", "#2c6fad")          # XIAO 断面
rect(bx + 60, by + 84, 26, 12, "#f7d9d9", "#b03a3a")           # アンテナ
txt(bx + 120, by + 78, "XIAO", 13, "middle", "normal", "#2c6fad")
# スペーサー（5mm 側）
rect(bx + 200, by + 66, 14, 30, "#e8f0d9", "#6a8a3a")
rect(bx + 320, by + 66, 14, 30, "#e8f0d9", "#6a8a3a")
txt(bx + 267, by + 88, "スペーサー 5mm 側", 12, "middle", "normal", "#6a8a3a")
# アルミ箔（斜め）
A(f'<path d="M {bx+150} {by+30} L {bx+360} {by+66}" stroke="#666" stroke-width="7" '
  f'stroke-linecap="round" fill="none"/>')
txt(bx + 300, by + 26, "アルミホイル（10cm 角）", 13, "start", "normal", "#555")
dim(bx + 76, by + 82, bx + 150, by + 34, "最短 5mm")
txt(bx, by + 126, "アルミ箔の「いちばん近い角」が、アンテナから 5mm。ずれてよい。測って記録すれば読める。", 13, "start", "normal", "#777")
txt(bx, by + 146, "⚠ 箔が垂れると 5mm より近くなる。縁を 5mm ほど折り返して腰を持たせる。", 13, "start", "bold", "#b03a3a")
