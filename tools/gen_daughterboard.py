...
#   整流               … D_PWR(3.50, 7.50) 横置き
#   3V3 の隣           … C_DB(5.40, 10.50)
#   （C_BULK(3.00, 10.97) は 2026-08-16 に削除。open-gaps #44）
#
# V3V3 は D_PWR → C_DB → XIAO の 3V3 と、ほぼ一直線に並ぶ
# （2026-08-16 まで D_PWR と C_DB の間に C_BULK が居た）。
POWER_PLACE = {                 # 参照名 → (x, y)
    "R_LO":     (-5.40, 13.59),   # 分圧の下（SENSE → GND）
    "R_HI":     (-2.00, 14.00),   # 分圧の上（VBATT_SW → SENSE）。横置き
    "SW_PWR":   (-0.50, 10.00),   # 電池から来る線を受けるランド
    "D_PWR":    ( 3.50,  7.50),   # VBATT_SW → V3V3
