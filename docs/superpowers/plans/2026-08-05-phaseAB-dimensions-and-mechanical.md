...
- ベース機（PD-KB800WNS ＝ HYBRID Type-S）の公称寸法: **幅 294mm / 奥行 120mm / 高さ 40mm（キートップ上面まで）**。PFU 公式仕様。
  - **品番差に注意**: 電池を積む HYBRID / BT 系は奥行 120mm、電池のない Professional 2 / Classic は 110mm。他品番の資料から奥行方向の寸法を借りない。
  - 「手前 20mm / 奥 32mm（フレームまで）」とチルトスタンド 0°/3°/6° は**レビュー記事由来で未検証**。Task A2 の真横写真採寸で確定させる。公称の 40mm が独立した検算になる。
