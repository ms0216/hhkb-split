...
## 5.9. マトリクスのダイオードは実測不要になった

**SD103AW（C130875）に替えて、保証値で詰められるようになった。**
VF ≦ 0.37V @ 20mA。実使用は 100µA でそれよりはるかに小さい。
必要なレールは 1.40V で、マイコンの 1.80V の内側。
**打ち止めはマイコン律速（1.10V/本）。**

（1N4148W のままだと 1mA 未満の最大値が規定されておらず、打ち止めが
1.12〜1.48V/本 の間で不定だった。）
