...
| **[#44](#44-2026-08-16-深いスリープ中は電源を切ってもすぐには切れないバルクコンデンサの電荷)** | **深いスリープ中に電源を OFF→ON してもリセットされない。実測 53 秒。****電源の入れ直しという最初の復旧手段が効かない**（普通は数秒で諦めて壊れたと判断する） | **測定は済んだ（53 秒）。次は方針の判断。**ブリーダ抵抗は 3V3 側にしか置けず、常時電流と引き換え（100kΩ でも待機の 1.5 倍）。**受容するか・回路を変えるかを決める** |
...
## #44 (2026-08-16) 深いスリープ中は、電源を切ってもすぐには切れない（バルクコンデンサの電荷）
