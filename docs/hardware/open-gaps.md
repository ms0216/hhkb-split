...
| [#39](#39-2026-08-13-対応完了-回路レビュー-8-件指摘-18) | `C_RAIL`（パスコン）を U1 の隣／J_DB の隣、どちらに置くべきか | **高周波・EMC の判断が要る。**両方の説明を自分で検証し、どちらも根拠が持たなかった。実測値（U1 から 10〜11mm・J_DB から 70mm 以上）は #39 に記録済み |
