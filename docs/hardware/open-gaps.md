...
| 左 | SPI_SCK / V3V3 | 同（**利用者が 2026-08-26 に置いたビア**・J_DB 本体の上 2.3mm） | (210.6,83.7) (212.1,83.7) | 1.21 / 2.28mm・0.94 / 2.29mm |
| 左 | SPI_MOSI / CS | 配線の上の B.Mask 窓 2.5×0.5 | (200.4,89.7) (200.8,88.4) | 1.05 / 2.53mm・0.65 / 1.23mm |
| 左 | GND | ビア | (218.1,78.1) | 8.18 / 8.70mm |

**✅ 2026-08-26 全 5+5 ネット露出・`test_every_debug_net_has_exposed_copper` 緑。**
...
左の DRC 警告 +2 は利用者のビアの `via_dangling`（片面だけ繋がる＝テスト点として正しい）。
