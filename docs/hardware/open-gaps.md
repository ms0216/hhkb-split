...
**この 3 つは「買う・刷る」の一覧に入らないので、抜け落ちやすい。**
...
| **[#33](#33-寒いと電池が残っていても起動しないかもしれない未試験)** | 打ち止めを温度で補正するか | **未試験。**冷蔵庫で測れる（¥0）。基板に影響しない |
| **[#34](#34-打ち止めの定義を維持から起動へ変えるか材料のみ)** | 打ち止めを「維持できる電圧」でなく**「起動できる電圧」**で定義し直すか | **材料のみ（2026-08-11・利用者の判断）。**#33 と一体で決める（#32 は 2026-08-11 に不成立で決着。ショットキーのまま） |
...
## 34. 打ち止めの定義を「維持」から「起動」へ変えるか（**材料のみ**）

**2026-08-11 の C4-3 から出てきた。決めない。材料として置く**（利用者の判断）。
