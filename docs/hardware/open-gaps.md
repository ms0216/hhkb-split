...
| 板 | ネット | 形 | 位置（KiCad 座標） | 他ネットまで |
|---|---|---|---|---|
| 右 | SPI_SCK / SPI_MOSI / CS / U1_U2 / V3V3 | ビアの裏面テンティングを外す | (79.5,91.9) (79.5,90.3) (76.6,89.6) (81.7,92.8) (77.9,94.8) | 0.71〜1.30mm |
| 右 | GND | 同 | (64.9,91.1) | 5.8mm |
| 左 | SPI_SCK / SPI_MOSI / CS / V3V3 | **配線の上の B.Mask 窓**（2.5×0.5mm・左は SPI 系にビアが無い） | (200.5,87.8) (200.4,89.7) (200.8,88.4) (195.8,89.1) | 0.65〜1.05mm |
| 左 | GND | ビア | (198.6,96.7) | 2.5mm |

⚠️ **半田付けの現実**: 左は幅 0.2mm の配線・隣の銅まで 0.65mm。右は φ0.56 のビア・
隣まで 0.7mm 前後。**AWG30 級の細線と先の細いこて前提**。窓の幅は 0.8 だと隣との
レジストの残りが規定を割り DRC 8 件になったので 0.5 にした。3 基板とも DRC 0/0。
