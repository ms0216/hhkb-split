...
| # | 何 | 次の一手 |
|---|---|---|
| **[#36](#36-重大-本体基板キーの基板に固定具が-1-つも無い)** | **本体基板に固定具が 1 つも無い**（2026-08-12 発見） | **発注前なら無料、発注後は不可能。**取付穴を足すか、受け入れるかを決める |
...
* **外し方** … 上端に残る **3.1mm の隙間**へ爪を掛け、上へずらしてから
  手前へ起こす。舌が庇から抜ける
* 撓むのは**板そのもの**（幅 111・厚 1.6）が 0.4mm 反るだけ。ε = 0.008%
...
| 電源スイッチ | 壁のポケットへ落とし込み（**耳が無い部品**） | **内側が開いている。**押し込む向きに留めが無い。**唇は実部品の寸法が確定してから**（下の #18 の調査。突出量が 2.8 か 4.0 か決着していない） |
| ゴム足 | 座ぐり＋粘着 | 市販品 |
