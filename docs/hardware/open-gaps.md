...
| [#21](#21-一部未解決-キーキャップ下-3-段-dsa--上-2-段は背の高いもの品番未特定) | 上 2 段のキャップ | **高さは決めた**（9.16 / 11.12mm）。その高さの実在品を探して買う |
...
| **[#32](#32-逆流防止を理想ダイオードp-mosfetにすると電池を使い切れる保留中)** | ショットキーを**理想ダイオード（P-MOSFET）**に替えるか | **保留中。**#23 が片づいてから調べる。満たせなければ現状のままでよい |
| **[#33](#33-寒いと電池が残っていても起動しないかもしれない未試験)** | 打ち止めを温度で補正するか | **未試験。**冷蔵庫で測れる（¥0）。基板に影響しない |
| **[#34](#34-打ち止めの定義を維持から起動へ変えるか材料のみ)** | 打ち止めを「維持できる電圧」でなく**「起動できる電圧」**で定義し直すか | **材料のみ（2026-08-11・利用者の判断）。**#32・#33 と一体で決める |
...
## 32. 逆流防止を理想ダイオード（P-MOSFET）にすると、電池を使い切れる（**保留中**）
