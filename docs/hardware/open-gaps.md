...
| [#40](#40-2026-08-14-c_rail-を削除したその跡地に浮いたgndビアが-1-本残っている) | **C_RAIL 削除で右基板に生じた浮き GND ビア 1 本**（未配線 1）を、どう繋ぎ戻すか | **配線に大きな変更が控えているので、それと併せて確認する**（利用者判断・2026-08-14）。単独で直しても塗り直しでやり直しになる |
