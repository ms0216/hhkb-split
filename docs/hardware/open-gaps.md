...
- **丸ピンソケットには丸ピン（マシンピン）ヘッダが必須**（0.64mm 角ピンは
  受け径 0.4〜0.5mm に合わず接点を痛める）。候補: 札幌貿易 con-078
  （ASIN B0925FJVG6・Amazon）
- スタック増加の目安: **座高 3.0mm ＋ オス樹脂の残り ≈0.5mm ≒ +3.5mm**
  （オスの樹脂をはんだ後に抜くか XIAO 上面側へ逃がした場合）。
  `DB_STACK_H` は 4.5 → **8.0mm 級**になる。天井余裕 17mm の内側
