...
## 30. ★未解決★ スタビライザの切り欠きに逃げが無い（実形状の検査で発覚）
...
| 組 | 量 | 見立て |
|---|---|---|
| `keycaps#3 × pcb_real#28` | 88.1mm³ | #28 が何かを特定していない。もう 1 基のスタビなら、**キャップの窪みを箱で表現できない**限界 |
...
> | 実形状の全組み合わせ（GitHub Actions） | **❌ 赤。**#30 ほか 4 件の指摘が出たまま。**KiCad のインストール自体がまだ一度も動いていない** |
