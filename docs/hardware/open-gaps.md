...
| **[#49](#49-2026-08-23-配線にオシロを当てるつもりだったが当てられない) 🔴 発注前** | **オシロを当てる場所を作るか。**利用者は「ビアや配線にプローブを当てるつもり」でいたが、**レジストの下なので針が届かない**。作るなら**テストパッド（φ1.0〜1.5mm・レジスト開口）＋隣に GND** が要る。**部品が増えるので発注前にしか決められない** | **測ってから決める。**置き場所（J_DB の奥・y<84 あたり）が空いているかは未測定 |
