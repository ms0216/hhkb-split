...
**必要性が未実測**（100mm FFC のループインダクタンス・BLE バーストの
回り込み）。
...
| **C_BULK**（100µF） | 主基板にあった。守る相手は **XIAO の µs 級の電流変動**（electrical-design 1-5）で、595 でも整流点でもない。主基板だと **FFC 100mm の外側**から供給することになる | **子基板へ移した。**XIAO の 3V3 パッドから 6.30mm |
