...
## ⚠️ 2026-08-12 — 回路レビュー中。下の「0 件」は緑の意味が弱い

熟練エンジニアの指摘 8 件を反映する作業が進行中。その過程で
**74LVC595（左 U1・右 U1/U2）と D_PWR にネットが 1 本も付いていない**
という致命的欠陥が見つかった（[open-gaps #37](open-gaps.md)）。
