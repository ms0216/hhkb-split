...
| [open-gaps.md #23](docs/hardware/open-gaps.md) | アンテナが地板に挟まれている件。**✅ 2026-08-23 に手 0（アルミ箔）で実測して決着**（E の差 −7dB・共振なし）。`export_fab.py` の門も開いた。発注前の利用者側の残りは **#52（SOD-123 の向きを JLCPCB のプレビューで確認）** |
